...
const ROLE = jwtDecoded.payload.role;
const MENU2 = ['All mail', 'Trash', 'Spam'];

const CONFIG = {
  ADMIN: ['Inbox', 'Starred', 'Send email', 'Drafts'],
  USER: ['Inbox', 'Send email'],
  OPERATOR: ['Inbox']
}

/*const getOptionsByRole = (role) => {
  if(role === 'ADMIN') {
    return ['Inbox', 'Starred', 'Send email', 'Drafts']
  }
}*/ 
